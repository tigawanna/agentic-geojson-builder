...
const DashboardMapProjectsIndexRoute =
  DashboardMapProjectsIndexRouteImport.update({
    id: '/map-projects/',
    path: '/map-projects/',
    getParentRoute: () => DashboardLayoutRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_dashboard/map-projects/': {
      id: '/_dashboard/map-projects/'
      path: '/map-projects'
      fullPath: '/map-projects/'
      preLoaderRoute: typeof DashboardMapProjectsIndexRouteImport
      parentRoute: typeof DashboardLayoutRoute
    }
    '/api/auth/$': {
      id: '/api/auth/$'
