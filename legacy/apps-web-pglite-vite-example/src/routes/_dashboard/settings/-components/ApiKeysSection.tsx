    ...
    return (
      <Empty data-test="api-keys-empty" className="bg-base-300">
        <EmptyHeader>
          ...
          <EmptyDescription>
            Create a key to access your map projects from AI agents and automation tools.
          </EmptyDescription>
        </EmptyHeader>
        <Button
          variant="outline"
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Generate keys to access your map projects from AI agents and automation tools.
            </CardDescription>
          </div>
          <Button
            variant="outline"
